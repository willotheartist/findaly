    ...
    <>
      ...
      <div className="pillar-page">
        <div className="mx-auto max-w-4xl px-6 py-16">
          ...
          <motion.h1 className="section-heading" initial="hidden" animate="show" variants={fadeUp}>Instagram</motion.h1>

          <div className="card mt-8">
            <p className="text-[16px] leading-[1.75] text-[#0a211f]/70">
              This is a placeholder page so the footer link doesn’t look broken.
              If you want, switch the footer to an external Instagram URL later.
            </p>
            <div className="mt-6 flex gap-3 flex-wrap">
              <Link href="/contact" className="underline underline-offset-2 text-[#0a211f]">Contact</Link>
              <Link href="/blog" className="underline underline-offset-2 text-[#0a211f]">Blog</Link>
            </div>
          </div>
          ...
          <div className="mt-14 border-t border-[#0a211f]/10 pt-6 text-[13px] text-[#0a211f]/40">
            ...
            <span className="text-[#0a211f]/65">Instagram</span>
          </div>
        </div>
      </div>
    </>
