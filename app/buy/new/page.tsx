...
export async function generateMetadata({ searchParams }: PageProps): Promise<Metadata> {
  ...
  const canonicalPath = pageNum > 1 ? `/buy/new?page=${pageNum}` : "/buy/new";
  const title = "New Boats for Sale | Findaly";
  const description =
    "Browse new boats for sale worldwide. Discover brand-new sailboats, motor yachts and catamarans listed on Findaly.";
  ...
  return (
    <>
      <div aria-hidden="true" style={{position:"absolute",width:1,height:1,overflow:"hidden",clip:"rect(0,0,0,0)",whiteSpace:"nowrap"}}>
        <h1>New Boats for Sale — Brand New Yachts on Findaly</h1>
        <p>Browse new boats and yachts for sale on Findaly. Find factory-new vessels from authorised dealers.</p>
        <nav>
          <a href="/">Home</a>
