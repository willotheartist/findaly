  ...
  return (
    <>
      <style>{`
        ...
        .dest-tag { display: inline-flex; align-items: center; padding: 8px 16px; border-radius: 100px; background: rgba(10,33,31,0.05); border: 1px solid rgba(10,33,31,0.08); font-size: 14px; color: #0a211f; font-weight: 500; }
      `}</style>
      ...
      <div className="pillar-page min-h-screen pb-0">
        ...
        <div className="relative h-[70vh] min-h-[520px] w-full overflow-hidden">
          ...
          <motion.div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6" variants={stagger} initial="hidden" animate="show">
            <motion.p className="text-[12px] font-semibold tracking-[0.2em] uppercase text-[#fff86c] mb-4" variants={fadeUp}>Charter a Yacht</motion.p>
            <motion.h1 className="text-[clamp(36px,6vw,72px)] font-bold leading-[1.05] tracking-[-0.025em] text-white max-w-3xl" variants={fadeUp}>
              The open water is{" "}
              <span className="text-[#fff86c]">waiting for you.</span>
            </motion.h1>
            ...
            <motion.div className="mt-8 flex gap-3 flex-wrap justify-center" variants={fadeUp}>
              <Link href="/buy?intent=CHARTER" className="inline-flex h-12 items-center justify-center rounded-xl bg-[#fff86c] px-7 text-[14.5px] font-semibold text-[#0a211f] transition-opacity hover:opacity-90">
                Find a Charter
              </Link>
              ...
              <div className="sticky top-28 space-y-5">
                ...
                <div className="overflow-hidden rounded-2xl border border-[#0a211f]/10">
                  ...
                  <div className="bg-[#0a211f] p-5">
                    ...
                    <p className="mt-1.5 text-[13px] text-white/50 leading-relaxed">Earn income from your vessel while it&apos;s not in use.</p>
            ...
            <article className="article-body min-w-0">
              <section id="why-charter" className="scroll-mt-28">
                ...
                <p>
                  ...
                  <strong>Charter gives you everything ownership offers — the freedom, the destinations, the lifestyle</strong> — without the maintenance, the marina fees, or the capital tied up at anchor.
                </p>
                <p>
                  Findaly&apos;s charter marketplace connects you directly with boat owners and professional charter operators across every major sailing region. No agency layers. No opaque pricing. Just the vessel, the owner, and the sea.
                </p>
                <div className="pull-quote">
                  &quot;Why own when you can charter a different yacht in a different destination every year?&quot;
                </div>
                <p>
                  For those who are ready to buy, charter is also the perfect way to trial a vessel type before committing. Spend a week on a catamaran in the Greek islands before you decide if it&apos;s the right choice for your next purchase.
                </p>
              </section>
              ...
              <section id="types" className="mt-20 scroll-mt-28">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                  {[
                    { icon: "⚓", title: "Bareboat Charter", body: "You captain the vessel. Full freedom, full responsibility. Requires a valid RYA, IYT, or equivalent licence." },
                    { icon: "👨‍✈️", title: "Crewed Charter", body: "Captain and crew included. Simply arrive, relax, and let the professionals handle everything from navigation to meals." },
              ...
              <section id="how-it-works" className="mt-20 scroll-mt-28">
                ...
                <div className="space-y-8 mt-8">
                  {[
                    { step: "01", title: "Search by destination or vessel type", body: "Filter by location, dates, vessel type, size, and budget. Findaly's search covers the Mediterranean, Caribbean, Pacific, and beyond." },
                    { step: "02", title: "Compare and shortlist", body: "Each charter listing shows full specs, photos, availability calendar, and pricing. Save favourites and compare side by side." },
                    { step: "03", title: "Contact the owner directly", body: "Send an enquiry through Findaly's messaging system. Negotiate directly, ask questions, and confirm your booking without any agency in between." },
                  ].map((item) => (
                    <div key={item.step} className="flex gap-5">
                      <div style={{ width: 36, height: 36, background: "#fff86c", color: "#0a211f", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, fontWeight: 700, flexShrink: 0 }}>{item.step}</div>
                      <div>
              ...
              <section id="destinations" className="mt-20 scroll-mt-28">
                ...
                <p>
                  ...
                  <strong>Greek island sunsets, Caribbean trade winds, or Norwegian fjords</strong>, you&apos;ll find the right vessel in the right place.
                </p>

                <div className="flex flex-wrap gap-2 mt-6">
                  {["Greek Islands", "French Riviera", "Croatia", "Balearic Islands", "Caribbean", "BVI", "Maldives", "Turkey", "Amalfi Coast", "Norwegian Fjords", "Sardinia", "Montenegro"].map((dest) => (
                    <Link key={dest} href={`/destinations`} className="dest-tag">{dest}</Link>
                  ))}
                </div>

                <p className="mt-8">
                  Each destination on Findaly has a dedicated page with editorial content covering sailing conditions, anchorages, marina guides, and the best times to visit.{" "}
              ...
              <div className="mt-20 mb-8 rounded-2xl bg-[#0a211f] p-10 md:p-14 text-center">
                ...
                <div className="mt-8 flex items-center justify-center gap-3 flex-wrap">
                  <Link href="/buy?intent=CHARTER" className="inline-flex h-11 items-center justify-center rounded-xl bg-[#fff86c] px-6 text-sm font-semibold text-[#0a211f]">Find a Charter</Link>
                  <Link href="/add-listing" className="inline-flex h-11 items-center justify-center rounded-xl border border-white/15 px-6 text-sm font-medium text-white/80 hover:bg-white/5 transition-colors">List your boat</Link>
                </div>
              </div>
            </article>
          </div>
