            ...
            <article className="article-body min-w-0">
              ...
              <section id="destinations" className="mt-20 scroll-mt-28">
                ...
                <div className="flex flex-wrap gap-2 mt-6">
                  {[
                    "Greek Islands","French Riviera","Croatia","Balearic Islands","Caribbean","BVI","Maldives","Turkey","Amalfi Coast","Norwegian Fjords","Sardinia","Montenegro",
                  ].map((dest) => (
                ...
                <p className="mt-8">
                  ...
                  <Link href="/destinations" className="underline underline-offset-2 text-[#0a211f]">Explore destinations →</Link>
                </p>
              </section>
              ...
              <div className="mt-20 mb-8 rounded-2xl bg-[#0a211f] p-10 md:p-14 text-center">
                ...
                <div className="mt-8 flex items-center justify-center gap-3 flex-wrap">
                  <Link href="/buy?intent=CHARTER" className="inline-flex h-11 items-center justify-center rounded-xl bg-[#fff86c] px-6 text-sm font-semibold text-[#0a211f]">
                    Find a Charter
                  </Link>
