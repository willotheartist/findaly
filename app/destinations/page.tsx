...
export default function DestinationsPage() {
  ...
  return (
    <main className="w-full bg-[#FAFAFA] text-slate-900">
      ...
      >
        <h1>Boat Charter and Sailing Destinations</h1>
        <p>
          Discover the best sailing and boat charter destinations worldwide
          including the Mediterranean, Caribbean, Greek islands and more.
        </p>
        <nav>
          <a href="/">Home</a>
      ...
      <div className="min-h-[calc(100vh-64px)] bg-[#FAFAFA] text-slate-900">
            ...
            <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-base leading-8 text-slate-700 sm:text-lg">
                  Explore iconic coastlines, island chains, marinas,
                  anchorages, and places actually worth arriving by water. These
                  pages are built to help you compare destinations faster — from
                  the French Riviera and Amalfi Coast to Greece, Croatia, Dubai,
              ...
              <div className="rounded-3xl border border-slate-200 bg-white p-4 shadow-[0_10px_40px_rgba(15,23,42,0.06)] sm:p-5">
                <div className="mb-3">
                  ...
                  <p className="mt-1 text-sm leading-6 text-slate-600">
                    Jump straight to a coastline, island group, or harbour
                    region.
                  </p>
                </div>
          ...
          >
            ...
            <div className="mt-6 rounded-3xl border border-slate-200 bg-white p-5">
              ...
              <p className="mt-2 max-w-3xl text-sm leading-7 text-slate-600">
                The best long-term play is to turn the strongest styles into
                their own indexable pages with unique intros, destination picks,
                route logic, internal linking, and service cross-sells — for
                example /destinations/luxury-yacht-destinations or
                /destinations/best-island-hopping-destinations.
              </p>
            </div>
          </DestinationSection>
