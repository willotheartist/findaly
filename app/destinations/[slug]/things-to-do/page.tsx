      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20">
        <div className="mb-10 flex items-end justify-between gap-6">
          <div className="max-w-2xl">
            ...
            <div className="mt-3 h-0.5 w-12 rounded-full bg-[#1a7a5c]" />

            <p className="mt-4 text-[15px] leading-relaxed text-[#999]">
              Curated destination guides covering marinas, anchorages, routes, beach clubs and local favourites.
            </p>
          </div>
        ...
        <div className="grid gap-6 lg:grid-cols-12">
          ...
          >
            <div className="relative flex min-h-[300px] flex-col justify-between p-8 sm:min-h-80 sm:p-10">
              <div>
                <div className="inline-flex items-center gap-2 rounded-md bg-black/6 px-3 py-1 text-[12px] font-medium text-[#0a211f]/70">
                  <span className="h-1.5 w-1.5 rounded-full bg-[#0a211f]" />
                  Featured guide
                </div>

                <div className="mt-6 text-[44px] font-light leading-none tracking-[-0.03em] text-[#0a211f] sm:text-[52px]">
                  {featured.city}
                </div>

                <div className="mt-2 text-[14px] text-[#0a211f]/55">
                  {featured.country}
                </div>
                ...
                <p className="mt-6 max-w-[44ch] text-[14px] leading-[1.7] text-[#0a211f]/65">
                  ...
                  standout stops and smarter day-plan ideas.
                </p>
              </div>
                  ...
                  >
                    <div className="min-w-0">
                      ...
                      <div className="mt-0.5 text-[12px] text-[#999]">
                        Marinas · Anchorages · Routes · Local picks
                      </div>
                    </div>
