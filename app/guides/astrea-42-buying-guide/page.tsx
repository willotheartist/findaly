...
import { Astrea42BuyingGuidePageClient } from "./Astrea42BuyingGuidePageClient";

export const metadata: Metadata = {
  title: "Fountaine Pajot Astrea 42 Buying Guide | Findaly",
  description: "Complete buying guide for the Fountaine Pajot Astrea 42. Layouts, prices, what to check and where to find Astrea 42s for sale.",
  alternates: { canonical: "/guides/astrea-42-buying-guide" },
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    title: "Fountaine Pajot Astrea 42 Buying Guide | Findaly",
    description: "Complete buying guide for the Fountaine Pajot Astrea 42. Layouts, prices, what to check and where to find Astrea 42s for sale.",
    url: "https://www.findaly.co/guides/astrea-42-buying-guide",
    siteName: "Findaly",
    type: "article",
  ...
  return (
    <>
      <div aria-hidden="true" style={{position:"absolute",width:1,height:1,overflow:"hidden",clip:"rect(0,0,0,0)",whiteSpace:"nowrap"}}>
        <h1>Fountaine Pajot Astrea 42 Buying Guide — Layouts, Prices and What to Check</h1>
        <p>Complete buying guide for the Fountaine Pajot Astrea 42. Layouts, prices, what to check and where to find Astrea 42s for sale.</p>
        <nav>
          <a href="/">Home</a>
