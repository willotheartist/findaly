...
import { Lagoon40BuyingGuidePageClient } from "./Lagoon40BuyingGuidePageClient";

export const metadata: Metadata = {
  title: "Lagoon 40 Buying Guide | Findaly",
  description: "Complete buying guide for the Lagoon 40 catamaran. Layouts, prices, what to check and where to find Lagoon 40s for sale.",
  alternates: { canonical: "/guides/lagoon-40-buying-guide" },
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    title: "Lagoon 40 Buying Guide | Findaly",
    description: "Complete buying guide for the Lagoon 40 catamaran. Layouts, prices, what to check and where to find Lagoon 40s for sale.",
    url: "https://www.findaly.co/guides/lagoon-40-buying-guide",
    siteName: "Findaly",
    type: "article",
  ...
  return (
    <>
      <div aria-hidden="true" style={{position:"absolute",width:1,height:1,overflow:"hidden",clip:"rect(0,0,0,0)",whiteSpace:"nowrap"}}>
        <h1>Lagoon 40 Buying Guide — Layouts, Prices and What to Check</h1>
        <p>Complete buying guide for the Lagoon 40 catamaran. Layouts, prices, what to check and where to find Lagoon 40s for sale.</p>
        <nav>
          <a href="/">Home</a>
