...
import { CatamaranBuyingGuidePageClient } from "./CatamaranBuyingGuidePageClient";

export const metadata: Metadata = {
  title: "Catamaran Buying Guide | Findaly",
  description: "Complete guide to buying a catamaran. Compare sailing vs power catamarans, layouts, brands, costs and what to look for when buying used.",
  alternates: { canonical: "/guides/catamaran-buying-guide" },
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    title: "Catamaran Buying Guide | Findaly",
    description: "Complete guide to buying a catamaran. Compare sailing vs power catamarans, layouts, brands, costs and what to look for when buying used.",
    url: "https://www.findaly.co/guides/catamaran-buying-guide",
    siteName: "Findaly",
    type: "article",
  ...
  return (
    <>
      <div aria-hidden="true" style={{position:"absolute",width:1,height:1,overflow:"hidden",clip:"rect(0,0,0,0)",whiteSpace:"nowrap"}}>
        <h1>Catamaran Buying Guide — Everything You Need to Know</h1>
        <p>Complete guide to buying a catamaran. Compare sailing vs power catamarans, layouts, brands, costs and what to look for when buying used.</p>
        <nav>
          <a href="/">Home</a>
      ...
      <CatamaranBuyingGuidePageClient />
    </>
  );
}
