...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Boat Buying Guides — Expert Advice from Findaly",
    description:
      "Expert boat buying guides covering catamarans, motor yachts, sailboats, Beneteau, Lagoon and more from Findaly.",
    url: "https://www.findaly.co",
    siteName: "Findaly",
    type: "website",
    images: [
      {
        url: "https://www.findaly.co/og-findaly.jpg",
        width: 1200,
        height: 630,
        alt: "Findaly",
      },
...
export default function GuidesHubPage() {
  return (
    <main className="min-h-screen bg-[#f5f2eb] text-[#0a211f]">
      ...
      >
        <h1>Boat Buying Guides — Expert Advice from Findaly</h1>
        <p>
          Expert boat buying guides covering catamarans, motor yachts,
          sailboats, Beneteau, Lagoon and more from Findaly.
        </p>
        <nav>
          <a href="/">Home</a>
          ...
          <a href="/guides/catamaran-buying-guide">
      ...
      <div className="min-h-screen bg-[#f5f2eb] text-[#0a211f]">
          ...
          <div className="relative h-[52vh] min-h-[420px] w-full">
            ...
            <div className="absolute inset-0 flex items-center justify-center px-6">
              <div className="max-w-3xl text-center">
                <p className="text-[12px] font-semibold uppercase tracking-[0.2em] text-[#fff86c]">
                  Findaly Guides
                </p>
                <h1 className="mt-4 text-[clamp(32px,5vw,64px)] font-bold leading-[1.05] tracking-[-0.03em] text-white">
                  ...
                  <span className="text-[#fff86c]">
                    {" "}
                    built to help you buy clean
                  </span>
                  .
                </h1>
                <p className="mx-auto mt-6 max-w-2xl text-[16.5px] leading-relaxed text-white/70">
                  Practical, no-fluff resources that link directly into live
                  inventory: brand hubs, model hubs, and listing pages.
                </p>
                ...
                <div className="mt-8 flex flex-wrap justify-center gap-3">
                  ...
                  <Link
                    href="/brokers"
                    className="inline-flex h-12 items-center justify-center rounded-xl border border-white/20 px-7 text-[14.5px] font-medium text-white transition-colors hover:bg-white/10"
                  >
                    Find a broker
                  </Link>
                </div>
        ...
        <section className="mx-auto max-w-6xl px-6 pt-14">
          <div className="grid gap-8 md:grid-cols-3">
            <div className="rounded-2xl border border-[#0a211f]/10 bg-[#0a211f]/2 p-6">
              <div className="text-[13px] font-bold uppercase tracking-[0.16em] text-[#0a211f]/45">
                Cluster strategy
              </div>
              <p className="mt-3 text-[15.5px] leading-relaxed text-[#0a211f]/70">
                Each guide links into Findaly’s hubs (brand/model/country/year),
                strengthening crawl paths and pushing authority into pages that
                actually convert.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-[#0a211f]/10 bg-[#0a211f]/2 p-6">
              ...
              <p className="mt-3 text-[15.5px] leading-relaxed text-[#0a211f]/70">
                These pages target informational queries (“pricing”,
                “inspection checklist”, “comparison”) and send users to
                commercial pages when they’re ready.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-[#0a211f]/10 bg-[#0a211f]/2 p-6">
              ...
              <p className="mt-3 text-[15.5px] leading-relaxed text-[#0a211f]/70">
                You’ll get clean: Guides → Brand hubs → Model hubs → Listings —
                plus lateral links between guides.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-6xl px-6 py-14">
          <div className="flex flex-wrap items-end justify-between gap-6">
            <div>
              <p className="text-[12px] font-semibold uppercase tracking-[0.18em] text-[#0a211f]/45">
                Browse guides
              </p>
            ...
            <Link
              href="/buy"
              className="inline-flex h-11 items-center justify-center rounded-xl border border-[#0a211f]/15 px-6 text-[14px] font-semibold text-[#0a211f] transition-colors hover:bg-[#0a211f]/5"
            >
              Browse yachts →
            </Link>
          </div>
            ...
            {GUIDES.map((g) => (
              ...
              >
                <div className="relative h-44">
                  ...
                  <div className="absolute left-4 top-4 rounded-full border border-white/25 bg-black/25 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.16em] text-white">
                    {g.tag}
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  <p className="mt-2 text-[13.5px] text-[#0a211f]/55">
                    {g.subtitle}
                  </p>
                  ...
                  <div className="mt-6 flex flex-wrap gap-2">
                    ...
                    {g.secondaryCtaHref ? (
                      <Link
                        ...
                        className="inline-flex h-10 items-center justify-center rounded-xl border border-[#0a211f]/15 px-4 text-[13px] font-semibold text-[#0a211f] transition-colors hover:bg-[#0a211f]/5"
                      >
                        {g.secondaryCtaLabel} →
                      </Link>
                    ) : null}
          ...
          <div className="mt-14 rounded-2xl border border-[#0a211f]/10 bg-[#0a211f]/2 p-8 text-center">
            <p className="text-[12px] font-semibold uppercase tracking-[0.2em] text-[#0a211f]/45">
              Want to move faster?
            </p>
            ...
            <p className="mx-auto mt-3 max-w-xl text-[14.5px] leading-relaxed text-[#0a211f]/65">
              Guides build confidence. Inventory builds intent. The best SEO
              pages connect both.
            </p>
            ...
            <div className="mt-7 flex flex-wrap justify-center gap-3">
              <Link
                href="/buy"
                className="inline-flex h-11 items-center justify-center rounded-xl bg-[#fff86c] px-6 text-[14px] font-semibold text-[#0a211f] transition-opacity hover:opacity-90"
              >
                Browse yachts
              </Link>
              <Link
