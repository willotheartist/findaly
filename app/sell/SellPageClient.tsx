          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[280px_1fr] lg:gap-16">
            ...
            <article className="article-body min-w-0">
              ...
              <section id="how-it-works" className="mt-20 scroll-mt-28">
                ...
                <h2 className="section-heading">Three steps to your first enquiry.</h2>
              ...
              <section id="your-listing" className="mt-20 scroll-mt-28">
                ...
                <h2 className="section-heading">A listing that works as hard as you do.</h2>
                <p>
                ...
                <div className="pull-quote">&quot;A great listing is half the sale.&quot;</div>
                <p>
              ...
              <section id="reach" className="mt-20 scroll-mt-28">
                ...
                <h2 className="section-heading">Your boat, seen by buyers in 50+ countries.</h2>
                <p>
                ...
                <p>
                  Buyers can save searches and set alerts. When your listing matches their criteria, they&apos;re notified automatically. Findaly&apos;s system helps your boat get seen by people actively looking for exactly what you&apos;re selling.
                </p>
              </section>

              <section id="faq" className="mt-20 scroll-mt-28">
                <p className="section-label">FAQ</p>
                <h2 className="section-heading">Common questions from sellers.</h2>
              ...
              <div className="mt-20 mb-8 rounded-2xl bg-[#0a211f] p-10 md:p-14 text-center">
                ...
                <h3 className="text-[clamp(26px,3.5vw,38px)] font-bold leading-[1.1] text-white tracking-tight">
                  List your boat today. <span className="text-[#fff86c]">It&apos;s free.</span>
                </h3>
