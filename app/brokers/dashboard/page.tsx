...
export default function BrokersDashboardPage() {
  return (
    <>
      <style>{`
      ...
      <div className="pillar-page">
        <div className="mx-auto max-w-6xl px-6 py-16">
          ...
          <motion.h1 className="section-heading" initial="hidden" animate="show" variants={fadeUp}>Broker dashboard</motion.h1>
          <motion.p className="text-[17px] leading-[1.75] text-[#0a211f]/70 max-w-2xl" initial="hidden" animate="show" variants={fadeUp}>
            MVP placeholder page. If your real dashboard UI exists elsewhere, we can route this to it next.
          </motion.p>

          <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { t: "Inventory", d: "Manage listings, media, and details." },
              { t: "Enquiries", d: "Respond quickly and track conversations." },
              { t: "Performance", d: "Views, saves, and lead intent signals." },
            ].map((x) => (
          ...
          <div className="mt-14 border-t border-[#0a211f]/10 pt-6 text-[13px] text-[#0a211f]/40">
            ...
            <span className="mx-2">/</span>
            <span className="text-[#0a211f]/65">Dashboard</span>
          </div>
        </div>
      </div>
    </>
